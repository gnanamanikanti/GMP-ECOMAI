  ...
  return (
    <div className="page-shell container">
      <div className="page-header-block">
        ...
        <p className="page-lead mb-0">Edit listing details and save — image changes are optional.</p>
      </div>

      <div className="surface-card">
        <div className="surface-card-header">
          <h2 className="surface-card-title mb-0">{product.name}</h2>
        </div>
        <div className="surface-card-body">
              <form className="row g-3" noValidate validated={validated.toString()} onSubmit={handleSubmit}>
                ...
                <div className="col-12 form-section">
                  ...
                  <label htmlFor="description" className="form-label form-label-app">Full description</label>
                  <textarea
                ...
                <div className="col-md-6 form-section">
                  <div className="form-section-title">Release</div>
                ...
                <div className="col-md-6 form-section">
                  ...
                  <label htmlFor="imageFile" className="form-label form-label-app">Product image</label>
                  {image && (
                    <div className="image-preview-app mb-3">
                      <img
                ...
                <div className="col-12 mt-2 pt-3 border-top d-flex flex-wrap gap-2" style={{ borderColor: 'var(--card-border)' }}>
                  {loading ? (
                    <button
