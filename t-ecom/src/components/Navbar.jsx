...
const handleLinkClick = () => {
  ...
  return (
    <nav className="app-navbar navbar navbar-expand-lg fixed-top" ref={navbarRef}>
  ...
  <span className="navbar-toggler-icon"></span>
        ...
        >
          ...
          <div className="d-flex align-items-center flex-wrap gap-2">
            ...
            >
              <i className={`bi ${theme === "dark-theme" ? "bi-sun-fill" : "bi-moon-stars-fill"}`}></i>
            </button>
            <a href="/cart" className="nav-link cart-link me-1" onClick={handleLinkClick}>
              <i className="bi bi-cart me-1"></i>
              Cart
            </a>
            <form className="d-flex flex-grow-1 flex-lg-grow-0" role="search" onSubmit={handleSubmit} id="searchForm" style={{ minWidth: "12rem" }}>
              <input
